...
<div class="right_col" role="main">
  <div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Order List (That Are Cancelled)</h2>
                ...
                while ($row = $get_order_info->fetch_assoc()) {
                  ...
                  <tr>
                    ...
                    <td align="center">
                      ...
                      <?php 
                      if (permission_check('view_cancelled_order_info_button')) {
                        ?>
                        <a  class="badge bg-green view_data"  id="<?php echo($row['serial_no']) ?>" data-toggle="modal" data-target="#view_modal"><i class="far fa-eye"></i>  View</a>
                      <?php } ?> 
                ...
                <div class="x_panel" style="background: #f2ffe6">
                  ...
                  <div class="x_content" style="background: #f2ffe6">
                    ...
                    <div style="margin : 20px" id="info_table">
                      ...
                      <div class="row" style="margin-top:10px" >
                        <div class="col-md-3"></div>
                        <div class="col-md-3"><h5 style="color:black">Company</h5></div>
                        <div class="col-md-3"><h5 style="color:black" id="company_employee"></h5></div>
                        <div class="col-md-3"></div>
                      </div>
                      ...
                      <div class="row" style="margin-top:10px" >
                        ...
                        <div class="row" style="margin-top:10px"><div class="col"> <h3 style="color:  #34495E">Order Information : </h3><span style="color: red"> Order Number:- <span id="order_no"></span></span><hr></div></div>
...
$(document).on('click','.view_data',function(){
  ...
  $.ajax({
    ...
    success:function(data){
      ...
      $("#company_employee").html(data.details['company']);
      ...
      $("#order_no").html(data.details['order_no']);
