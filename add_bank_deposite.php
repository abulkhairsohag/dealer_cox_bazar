...
<div class="right_col" role="main">
  <div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Bank Deposite List</h2>
          <div class="row float-right" align="right">
            <?php 
            if (permission_check('add_bank_deposite_button')) {
              ?>
              <a href="" class="btn btn-primary" id="add_data" data-toggle="modal" data-target="#add_update_modal"> <span class="badge"><i class="fa fa-plus"> </i></span> Add New Bank Deposite</a>
            <?php } ?>
          </div>
                ...
                <div class="x_panel" style="background: #f2ffe6">
                  ...
                  <div class="x_content" style="background: #f2ffe6">
                    ...
                    <form id="form_edit_data" action="" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Deposite Date <span class="required" style="color: red">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="deposite_date" name="deposite_date" class="date-picker form-control col-md-7 col-xs-12 datepicker" required="required"  autocomplete="off" readonly="">
                        </div>
                      </div>
...
<script>
  $(document).ready(function(){
    ...
    $(document).on('click','.edit_data',function(){
      ...
      $("#ModalLabel").html("Update Bank Deposite Information.");
      $("#submit_button").html("Update");
      var serial_no_edit = $(this).attr("id");

      $.ajax({
        url:"ajax_add_bank_deposite.php",
    ...
    $(document).on('click','#add_data',function(){
      $("#ModalLabel").html("Add New Bank Deposite Information.");
      ...
      $("#branch_name").val("");
      $("#amount").val("");
      $("#deposite_date").val("<?php echo(date("d-m-Y")) ?>");
      $("#description").val("");
      $("#edit_id").val("");
    });
