...
<table class="table" class="">
  ...
  <tbody id="invoice_details">
    ...
    <td  style="display:none" ><input type="text"   class="form-control main_offer_qty offer_qty" id="offer_qty" name="offer_qty[]" readonly=""></td>
