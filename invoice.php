...
if (isset($_GET['serial_no'])) {
   $serial_no = $_GET['serial_no'];
    ...
    if ($serial_no) {
        ...
        $result_order_details = $dbOb->select($query_order_details);

        if ($result_order_details) {
           $result_order_details = $result_order_details->fetch_assoc();
        }

        $payable_amt = $result_order_details['payable_amt'];
        $employee_id = $result_order_details['employee_id'];
// order information
        $query = "SELECT * FROM new_order_expense WHERE new_order_serial_no = '$serial_no'";
...
<head>
    ...
    <style>
        ...
        .print_btn2 {
            ...
            width: 120px;
            border-radius: 40px;
            background-image: linear-gradient( 109.6deg,  rgba(176, 61, 61, 1) 11.3%, rgba(138, 35, 164) 91.1% );
            font-size: 22px;
            padding-top: 2px;
            font-weight: bold;
        }
            ...
            <div class="row">
                ...
                <div class="col-md-6 pt-3">
                    <div class="text-center">
                        <span class="legend-pharma text-uppercase display-1 font-weight-bold"><?php echo $result_company['organization_name']; ?></span>
                        <br>
                        ...
                        <table class="table table-sm table-borderless">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>: <?php echo $result_order_details['area_employee']; ?></td>
                                </tr>
                                <tr>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['pack_size']; ?>`s</td>
             ...
             <?php  }
                     ...
                     ?>
                    <tr>
                        <th class="dd blank" scope="row" colspan="6"  > </th>
                    ...
                    <tr>
                        <th scope="row" class="blank" colspan="6"  >  Note : </th>
                        <td colspan="2">Discount On TP : <?php echo $result_order_details['discount_on_tp'] ?>%</td>
                        <td>-<?php echo round($result_order_details['discount_amount'],2) ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>-<?php 
                        $amt = round($result_order_details['payable_without_extra_discount']*$result_order_details['extra_discount']/100, 2); 
                        echo $amt; ?></td>
                    </tr>
...
?>
                        <th scope="row" colspan="6" class="border-none text-uppercase blank" >  IN WORD: <?php echo convertNumberToWord($payable_amt).' ONLY'; ?>   </th>
    ...
    <section class="" style="margin-top: 200px">
        ...
        <hr>
        <div class="container-fulid">
            <p>Warrenty <span>: We do hereby give the warrenty that product sold under this invoice don't contravene to any provisions of section 18 of the drugs act. 1940</span></p>
            <p>Note <span>: Received the goods in full and good condition</span></p>
        </div>
</div>
        <div class="text-center mb-3 print_none">
    
    <a class=" text-light btn-success btn print_btn" onclick="printContent('print_table')"><i class="icon-printer"></i> Print </a>
    <a class=" text-light btn-warning btn print_btn2" href="deliver.php?serial_no=<?php echo urldecode($serial_no);?>"><i class="icon-printer"></i> Deliver </a>
    
    <!-- <a href="deliver.php?serial_no=<?php //echo urldecode($row['serial_no']);?>" class="badge  bg-orange ">Deliver Order </a> -->
</div>
