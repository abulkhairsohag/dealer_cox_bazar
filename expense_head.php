...
<div class="right_col" role="main">
	<div class="row">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <?php 
            if(permission_check('add_expense_head_button')){
              ?>
              <a href="" class="btn btn-primary" id="add_data" data-toggle="modal" data-target="#add_update_modal"> <span class="badge"><i class="fa fa-plus"> </i></span> Add Expense Head</a>
              <?php 
            }
            ?>
         ...
         <table id="datatable-buttons" class="table table-striped table-bordered">
          <thead>
           <tr>
            ...
            <th  style="text-align: center;">Expense Head Name</th>
          ...
          if ($get_expense_head) {
            ...
            while ($row = $get_expense_head->fetch_assoc()) {
              ...
              <tr>
                ...
                <td align="center">
                  <?php 
                  if(permission_check('expense_head_edit_button')){
                    ?>
                  ...
                  ?>
                  <?php 
                  if(permission_check('expense_head_delete_button')){
                    ?>
              ...
              <div class="x_content" style="background: #f1f5f2">
                ...
                <form id="form_add_edit_data" data-parsley-validate class="form-horizontal form-label-left" action="" method="post">
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Expense Head Name<span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="head_name" name="head_name" required="required" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
