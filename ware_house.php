          ...
          <table id="datatable-buttons" class="table table-striped table-bordered">
            <thead>
              ...
              <tr>
                ...
                <th style="text-align: center;">Ware House Name</th>
                  ...
                  <div class="x_content" style="background: #f2ffe6">
                    ...
                    <form id="form_edit_data" action="" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                     ...
                     <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Ware House Name<span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text"  required=""id="ware_house_name" name="ware_house_name" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
...
<script>
  $(document).ready(function(){
    ...
    $(document).on('click','.edit_data',function(){
      ...
      $("#ModalLabel").html("Update Ware House Information");
      $("#submit_button").html("Update");
      var serial_no_edit = $(this).attr("id");

      $.ajax({
        url:"ajax_ware_house.php",
        data:{serial_no_edit:serial_no_edit},
        type:"POST",
        dataType:'json',
        success:function(data){
          $("#ware_house_name").val(data.ware_house_name);
    ...
    $(document).on('click','#add_data',function(){
      $("#ModalLabel").html("Provide New Ware House Information");
